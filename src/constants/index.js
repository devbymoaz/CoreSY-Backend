...
const ERROR_MESSAGES = {
  ...
  CASHIER_INVALID_CREDENTIALS: 'Invalid email, employee ID, or password.',
  CASHIER_NOT_ACTIVE: 'Cashier account is not active. Please contact the business owner.',
  CASHIER_SUSPENDED: 'Cashier account has been suspended.',
...
const SUCCESS_MESSAGES = {
  ...
  CASHIER_LOGIN_SUCCESS: 'Cashier login successful.',
